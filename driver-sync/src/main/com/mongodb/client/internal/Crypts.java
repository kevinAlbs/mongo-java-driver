...
final class Crypts {
    ...
    static Crypt createCrypt(final MongoClient client, final AutoEncryptionOptions options) {
         return new Crypt(MongoCrypts.create(createMongoCryptOptions(options.getKmsProviders())),
                ...
                options.getNamespaceToLocalSchemaDocumentMap(), options.isBypassAutoEncryption());
    }
