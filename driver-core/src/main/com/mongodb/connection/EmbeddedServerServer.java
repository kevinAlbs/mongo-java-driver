...
class EmbeddedServerServer implements Server, Closeable {
    ...
    EmbeddedServerServer(final EmbeddedServer embeddedServer, final ClusterId clusterId, final ClusterClock clusterClock) {
