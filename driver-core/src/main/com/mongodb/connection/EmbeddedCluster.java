...
public class EmbeddedCluster implements Cluster {

    private static final Logger LOGGER = Loggers.getLogger("cluster");
    private final ClusterSettings clusterSettings;
    private final ClusterDescription clusterDescription;
    private final EmbeddedServerServer server;
    private volatile boolean isClosed;

    // Todo ClusterSettings? Cluster Listener?
    public EmbeddedCluster(final List<String> argv, final List<String> envp, final EmbeddedServerFactory embeddedServerFactory) {
        this.server = new EmbeddedServerServer(embeddedServerFactory.create(argv, envp), new ClusterId(),  new ClusterClock());
