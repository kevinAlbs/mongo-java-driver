...
public class JsonPoweredCrudTestHelper {
    ...
    BsonDocument getBulkWriteResult(final BsonDocument arguments) {
        ...
        if (arguments.containsKey("ordered")) {
            ordered = arguments.getBoolean("ordered").getValue();
        }
        ...
        return toResult(collection.withWriteConcern(writeConcern).bulkWrite(writeModels, new BulkWriteOptions().ordered(ordered)));
    }
}
