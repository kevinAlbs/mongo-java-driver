...
public class Mongo {
    ...
    // TODO: replace with check for ClusterDescription.logicalSessionTimeout != null
    private boolean sessionsAreSupported() {
        ...
        for (ServerDescription serverDescription : clusterDescription.getServerDescriptions()) {
            if (serverDescription.isOk() && serverDescription.getMaxWireVersion() < 6) {
                return false;
            }
        }
        return true;
